...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        Arrays.stream(solution.intersect(new int[]{1,2,2,1}, new int[]{2,2})).forEach(System.out::print);
        System.out.println(" ");
        Arrays.stream(solution.intersect(new int[]{4,9,5}, new int[]{9,4,9,8,4})).forEach(System.out::print);
    }
}
